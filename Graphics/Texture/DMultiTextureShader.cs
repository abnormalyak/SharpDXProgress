...
{
    public class DMultiTextureShader
    {
        #region Structs
        ...
        public DMultiTextureShader() { }

        public bool Initialize(Device device, IntPtr windowHandle)
        {
            return InitializeShader(device, windowHandle, "Tut17MultiTexVS.hlsl", "Tut17MultiTexPS.hlsl");
        }
        ...
        public bool Render(
            ...
            ShaderResourceView[] textureArray)
        {
            ...
            ShaderResourceView[] textureArray)
        {
            try
            {
                ...
                deviceContext.PixelShader.SetShaderResources(0, 2, textureArray);
