...
namespace SharpDXPractice.Graphics
{
    public class DFontShader
    {
        ...
        {
            return InitializeShader(device, windowHandle, "Tut12FontVS.hlsl", "Tut12FontPS.hlsl");
        }
            ...
            Vector4 pixelColor)
        {
            try
            {
                ...
                deviceContext.MapSubresource(ConstantPixelBuffer,
                    MapMode.WriteDiscard,
                    MapFlags.None,
                    out mappedResource);
                ...
                // Set the constant buffer in the pixel shader with the updated value
                deviceContext.PixelShader.SetConstantBuffer(bufferSlotNumber, ConstantPixelBuffer);
